...
var UpdateAndFetchOperation = function (_DelegateOperation) {
  ...
  function UpdateAndFetchOperation(builder, name, opt) {
  ...
  UpdateAndFetchOperation.prototype.onAfterInternal = function onAfterInternal(builder, result) {
    var _this2 = this;
    ...
    return builder.modelClass().query().childQueryOf(builder).whereComposite(builder.modelClass().getFullIdColumn(), this.id).first().then(function (fetched) {
      ...
      return (0, _promiseUtils.afterReturn)(_DelegateOperation.prototype.onAfterInternal.call(_this2, builder, result), retVal);
    });
  };
